...
ACTIVE_RECORD_ENCRYPTION_DETERMINISTIC_KEY=${OTP_SECRET}
ACTIVE_RECORD_ENCRYPTION_KEY_DERIVATION_SALT=${SECRET_KEY_BASE}
ACTIVE_RECORD_ENCRYPTION_PRIMARY_KEY=${OTP_SECRET}
